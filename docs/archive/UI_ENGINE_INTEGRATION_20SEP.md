> Archived 2026-09-24. This was the head of `UI_ENGINE_INTEGRATION.md`: the
> 20 September integration record and launch notes for the old nested
> checkout. Current launch steps are in `docs/START_HERE.md`; the UI contract
> moved to `docs/UI_CONTRACT.md`.
