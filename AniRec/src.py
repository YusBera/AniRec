...
def main():
    ...
    """
    try:
        print("Welcome to the MyAnimeList Anime Fetcher!")
        ...
        if choice == "1":
            ...
            username = input("Enter the username of the user whose completed anime data you want to fetch: ").strip()
            ...
            if not completed_animes_df.empty:
                ...
                # Optionally save the data
                save_data = input("Do you want to save the completed anime data to a CSV file? (y/n): ").strip().lower()
                if save_data == "y":
