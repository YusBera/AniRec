...
/** A page's name, as any site titles a page (D-019): no "X // Y" legend. */
export function PageHeading({ name }: { name: string }) {
  return <h1 className="page-heading" tabIndex={-1}>{name}</h1>;
}
